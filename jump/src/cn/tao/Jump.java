 ...
 * @author Hylun 
 * @author LiuTao
 * @since  2018年2月4日下午5:21:00
 */
public class Jump {

    private static String adb = "";
    private static float rate = 1.50f;
    ...
    private static void showView() {
        JFrame view = new JFrame("跳不动,就是跳不动");
        ...
        view.getContentPane().add(new JLabel("项目源码:www.github.com/telltao/jump"));

        view.getContentPane().add(new JLabel("调节时间间隔"));
    ...
    private static void run() throws Exception {
        ...
        while (running) {
            ...
            step = 4;//暂停2-3秒左右
            Thread.sleep(1000 + new Random().nextInt(250));
            System.err.println(1000 + new Random().nextInt(250));
        }
    }
